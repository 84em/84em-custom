...
rsync -avz --exclude 'deploy.sh' --exclude '.git' --exclude 'node_modules' /home/andrew/workspace/84em/app/public/wp-content/plugins/84em-custom/ 84em:/www/g84emcom_126/public/wp-content/plugins/84em-custom
